  ...
  return (
    <div className="datatable">
      ...
      {props.files.map(row => {
        ...
        <div className="second-section-1">User Details</div>
        <div className="second-section-2">
          <div className="second-section-3">BLACKLIST USER</div>
          <div className="second-section-4">ACTIVATE USER</div>
        </div>
      </div>
      <div className="third-section">
        <div className="third-section-1">
          <div className="third-section-2">
            ...
            <div className="third-section-4">
              <h3>Grace Effiom</h3> <p>lMegfefbd</p>
            </div>
            <div className="third-section-5">
              <p>User's Tier</p>
              <div className="svg">
                <svg
                  width="16"
            ...
            <div className="third-section-6">
              <h3>N200,000.00</h3>
              <p>1234567890/Providus Bank</p>
            </div>
          </div>
        </div>
        <div className="third-section-7">
            <div className="classlist current">General Details</div>
            <div className="classlist">Documents</div>
            <div className="classlist">Bank Details</div>
            <div className="classlist">Loans</div>
            <div className="classlist">Savings</div>
            <div className="classlist">App and System</div>
        </div>
      </div>
